...
import com.aldogg.sorter.intType.collection.Entity1;
...
public class IntSorterTest extends BaseTest {
    ...
    private void testObjectSort(Object[] list, IntComparator comparator, TestSortResults testSortResults, ObjectIntSorter[] sorters) {
    ...
    public void speedTestSignedIntSt() throws IOException {
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter("test-results/speed_signedInt_st_"+branch+".csv"));
        writer.write("\"Size\"" + "," + "\"Range\"" + "," + "\"Sorter\"" + "," + "\"Time\"" + "\n");
...
//            testSpeedObject(ITERATIONS, params, testSortResults, sorters, comparator, writer);
    ...
    private void testSpeedObject(int iterations, GeneratorParams params, TestSortResults testSortResults, ObjectIntSorter[] sorters, IntComparator comparator, Writer writer) throws IOException {
        Function<GeneratorParams, int[]> function = IntGenerator.getGFunction(params.function);
        for (int iter = 0; iter < iterations; iter++) {
