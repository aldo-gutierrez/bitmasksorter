...
public class IntBasicTest extends BaseTest {
    ...
    public void basicTests() {
        ...
        testSort(new int[]{}, sorterTests, null);
        testSort(new int[]{1}, sorterTests, null);
        testSort(new int[]{2, 1}, sorterTests, null);
        testSort(new int[]{1, 2}, sorterTests, null);
        testSort(new int[]{1, 1}, sorterTests, null);
        testSort(new int[]{53, 11, 13}, sorterTests, null);
        testSort(new int[]{70, 11, 13, 53}, sorterTests, null);
        testSort(new int[]{54, 46, 95, 96, 59, 58, 29, 18, 6, 12, 56, 76, 55, 16, 85, 88, 87, 54, 21, 90, 27, 79, 29, 23, 41, 74}, sorterTests, null);
        testSort(new int[]{
                ...
                31, 70, 13, 16, 40, 31, 55, 81, 75, 71, 16, 31, 27, 17, 5, 36, 29, 63, 60}, sorterTests, null);
        //test bit mask 110110000 and 111110000
        testSort(new int[]{432, 496, 432, 496, 432, 496, 432, 496, 432, 496, 432, 496, 432, 496, 432, 496, 432, 496, 432, 432, 496, 496, 496, 496, 496, 432}, sorterTests, null);
    }
    ...
    public void testNegativeNumbers() {
        ...
        testSort(new int[]{}, testSorter, null);
        testSort(new int[]{1}, testSorter, null);
        testSort(new int[]{2, 1}, testSorter, null);
        testSort(new int[]{1, 2}, testSorter, null);
        testSort(new int[]{1, 1}, testSorter, null);
        testSort(new int[]{53, 11, 13}, testSorter, null);
        testSort(new int[]{70, 11, 13, 53}, testSorter, null);
        testSort(new int[]{-70, -11, -13, -53}, testSorter, null);
        testSort(new int[]{-54, -46, -95, -96, -59, -58, -29, 18, 6, 12, 56, 76, 55, 16, 85, 88, 87, 54, 21, 90, 27, 79, 29, 23, 41, 74}, testSorter, null);
    ...
    public void testBooleans() {
        ...
        testSort(new int[]{33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0, 33554431, 0}, sorter, null);
    }
