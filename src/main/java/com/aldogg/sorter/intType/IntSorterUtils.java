...
public class IntSorterUtils {
    ...
    public static int partitionReverseStable(final int[] array, final int start, final int end, final int mask, final int[] aux, final int startAux) {
        int left = start;
        int right = startAux;
        for (int i = start; i < end; i++) {
            int element = array[i];
     ...
     * MEM: O(N), N + 2*2^K
     */
    public static void partitionStableLastBits(final int[] array, final int start, final int[] aux, final int startAux, final int n, final Section section, final int[] leftX, final int[] count) {
    ...
    public static void partitionStableNGroupBits(final int[] array, final int start, final int[] aux, int startAux, final int n, final Section[] sections, final int[] leftX, final int[] count) {
        int end = start + n;
        for (int i = start; i < end; i++) {
            int element = array[i];
    ...
    private static void executeSorter(final int[] array, final int start, final int end, final int[] kList, final int kIndex, final ShortSorter sorter) {
        int n = end - start;
